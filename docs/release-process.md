...
Beta releases use `OUTLAYS_DESKTOP_RELEASE_CHANNEL=beta` and a semver prerelease such as `0.2.0-beta.1`. Stable releases use `OUTLAYS_DESKTOP_RELEASE_CHANNEL=stable` and a non-prerelease semver such as `1.0.0`.
