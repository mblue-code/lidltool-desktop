...
def build_pack(output_dir: Path) -> Path:
    ...
    packaged_manifest["entrypoint"] = "payload/plugin.py:ReweReceiptPlugin"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build a desktop receipt-pack ZIP for the REWE plugin.")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "dist",
