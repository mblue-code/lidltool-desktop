...
const DESKTOP_ONLY_MESSAGES = {
  en: {
    ...
    "shell.menu.reportProblem": "Report a problem",
    "shell.menu.createDiagnosticsBundle": "Create diagnostics bundle",
    "shell.menu.checkForUpdates": "Check for Updates",
    "shell.menu.openLogsFolder": "Open Logs Folder",
    "shell.menu.documentation": "Documentation",
  ...
  de: {
    ...
    "shell.menu.reportProblem": "Problem melden",
    "shell.menu.createDiagnosticsBundle": "Diagnosepaket erstellen",
    "shell.menu.checkForUpdates": "Nach Updates suchen",
    "shell.menu.openLogsFolder": "Protokollordner öffnen",
