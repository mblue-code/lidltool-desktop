...
const sourceMessagesPath = resolve(sourceRepoRoot, "frontend", "src", "i18n", "messages.ts");
...
// Generated by apps/desktop/scripts/sync-shell-i18n.mjs from frontend/src/i18n/messages.ts.
