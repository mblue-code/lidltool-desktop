...
export const DESKTOP_MESSAGES = {
  "en": {
    ...
    "shell.backup.description": "Create a local backup directory with the database, credentials, and optional exports/documents.",
    ...
    "shell.analytics.description": "Fetch `/api/v1/dashboard/cards` from the local backend for quick post-sync checks.",
  ...
  "de": {
    ...
    "shell.backup.description": "Ein lokales Backup-Verzeichnis mit Datenbank, Zugangsdaten und optionalen Exporten/Dokumenten erstellen.",
    ...
    "shell.analytics.description": "`/api/v1/dashboard/cards` vom lokalen Backend für schnelle Nachkontrollen nach dem Sync abrufen.",
