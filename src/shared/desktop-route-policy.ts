...
export const DESKTOP_ROUTE_CAPABILITIES: DesktopRouteCapability[] = [
  ...
  { route: "/sources", availability: "preview", navVisible: false, redirectTo: null, reason: "desktop_preview" },
  { route: "/explore", availability: "preview", navVisible: false, redirectTo: null, reason: "desktop_preview" },
  { route: "/products", availability: "preview", navVisible: false, redirectTo: null, reason: "desktop_preview" },
  { route: "/offers", availability: "unsupported", navVisible: false, redirectTo: "/", reason: "desktop_out_of_scope" },
  { route: "/compare", availability: "preview", navVisible: false, redirectTo: null, reason: "desktop_preview" },
  { route: "/quality", availability: "preview", navVisible: false, redirectTo: null, reason: "desktop_preview" },
  { route: "/patterns", availability: "preview", navVisible: false, redirectTo: null, reason: "desktop_preview" },
  { route: "/documents/upload", availability: "adapted", navVisible: false, redirectTo: "/imports/ocr", reason: "desktop_override" },
