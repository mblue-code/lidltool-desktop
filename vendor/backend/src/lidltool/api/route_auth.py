...
HTTP_ROUTE_AUTH_MATRIX: tuple[RouteAuthPolicy, ...] = (
    ...
    RouteAuthPolicy("GET", "/api/v1/shared-groups/user-directory", "authenticated_user_session"),
    RouteAuthPolicy("GET", "/api/v1/shared-groups", "authenticated_user_session"),
    RouteAuthPolicy("POST", "/api/v1/shared-groups", "authenticated_user_session"),
    RouteAuthPolicy("GET", "/api/v1/shared-groups/{group_id}", "authenticated_user_session"),
    RouteAuthPolicy("PATCH", "/api/v1/shared-groups/{group_id}", "authenticated_user_session"),
    RouteAuthPolicy("POST", "/api/v1/shared-groups/{group_id}/members", "authenticated_user_session"),
    RouteAuthPolicy(
        "PATCH",
        "/api/v1/shared-groups/{group_id}/members/{user_id}",
        "authenticated_user_session",
    ),
    RouteAuthPolicy(
        "DELETE",
    ...
    RouteAuthPolicy("GET", "/api/v1/transactions/facets", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/transactions/recategorize", "admin_only"),
    RouteAuthPolicy("POST", "/api/v1/transactions/categorization-agent", "authenticated_principal"),
    ...
    RouteAuthPolicy("POST", "/api/v1/ingestion/sessions", "authenticated_principal"),
    RouteAuthPolicy("GET", "/api/v1/ingestion/sessions", "authenticated_principal"),
    RouteAuthPolicy("GET", "/api/v1/ingestion/sessions/{session_id}", "authenticated_principal"),
    RouteAuthPolicy("PATCH", "/api/v1/ingestion/sessions/{session_id}", "authenticated_principal"),
    RouteAuthPolicy("DELETE", "/api/v1/ingestion/sessions/{session_id}", "authenticated_principal"),
    RouteAuthPolicy("GET", "/api/v1/settings/ingestion-agent", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/settings/ingestion-agent", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/sessions/{session_id}/message", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/sessions/{session_id}/run", "authenticated_principal"),
    RouteAuthPolicy("GET", "/api/v1/ingestion/sessions/{session_id}/proposals", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/sessions/{session_id}/files", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/files/{file_id}/parse", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/sessions/{session_id}/pasted-table", "authenticated_principal"),
    RouteAuthPolicy("GET", "/api/v1/ingestion/sessions/{session_id}/rows", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/sessions/{session_id}/classify-rows", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/sessions/{session_id}/proposals", "authenticated_principal"),
    RouteAuthPolicy("PATCH", "/api/v1/ingestion/proposals/{proposal_id}", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/proposals/{proposal_id}/approve", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/proposals/{proposal_id}/reject", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/proposals/{proposal_id}/refresh-matches", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/proposals/{proposal_id}/commit", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/proposals/{proposal_id}/undo", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/proposals/batch-approve", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/proposals/batch-commit", "authenticated_principal"),
    RouteAuthPolicy("POST", "/api/v1/ingestion/proposals/batch-reject", "authenticated_principal"),
    ...
    RouteAuthPolicy("PATCH", "/api/v1/sources/{source_id}/reporting-role", "admin_only"),
    ...
    RouteAuthPolicy("POST", "/api/v1/connectors/{source_id}/bootstrap/confirm", "authenticated_principal"),
    ...
    RouteAuthPolicy("PATCH", "/api/v1/sources/{source_id}/workspace", "authenticated_principal"),
    RouteAuthPolicy("PATCH", "/api/v1/transactions/{transaction_id}/workspace", "authenticated_principal"),
    RouteAuthPolicy("PATCH", "/api/v1/transactions/{transaction_id}/items/{item_id}/allocation", "authenticated_principal"),
