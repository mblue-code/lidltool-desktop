...
_BUILTIN_CONNECTOR_MANIFEST_DEFINITIONS: tuple[dict[str, Any], ...] = (
    {
        ...
        "builtin_cli": {
            "bootstrap_args": ["-m", "lidltool.cli", "auth", "bootstrap"],
            "sync_args": ["-m", "lidltool.cli", "sync"],
        },
    },
    {
        ...
        "builtin_cli": {
            ...
            "sync_args": ["-m", "lidltool.cli", "amazon", "sync", "--domain", "amazon.de"],
        },
    },
    {
        "plugin_id": "builtin.rewe_de",
        "plugin_version": "1.0.0",
        "connector_api_version": "1",
        "plugin_family": "receipt",
        "source_id": "rewe_de",
        ...
        "license": "MIT",
        "runtime_kind": "builtin",
        "entrypoint": "lidltool.connectors.rewe_adapter:ReweConnectorAdapter",
        "auth_kind": "browser_session",
        "auth": {
            "auth_kind": "browser_session",
            "supports_live_session_bootstrap": True,
    ...
    },
    {
        ...
        "license": "MIT",
        "runtime_kind": "builtin",
        "entrypoint": "lidltool.connectors.dm_adapter:DmConnectorAdapter",
        "auth_kind": "browser_session",
        "auth": {
            "auth_kind": "browser_session",
            "supports_live_session_bootstrap": True,
        ...
        "builtin_cli": {
            ...
            "sync_args": ["-m", "lidltool.cli", "dm", "sync", "--domain", "www.dm.de"],
        },
    },
    {
