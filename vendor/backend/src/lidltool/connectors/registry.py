...
_BUILTIN_CONNECTOR_MANIFEST_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    {
        "plugin_id": "builtin.lidl_plus_gb",
        "plugin_version": "1.0.0",
        "connector_api_version": "1",
        "plugin_family": "receipt",
        "source_id": "lidl_plus_gb",
        "display_name": "Lidl Plus UK",
        "merchant_name": "Lidl",
        "country_code": "GB",
        "maintainer": "lidltool",
        "license": "MIT",
            ...
            "fields": [
                {
                    "key": "years",
                    "label": "Years to scan",
                    "description": "Optional. Defaults to 2 years when left unchanged.",
                    "input_kind": "number",
                    "default_value": 2,
                    "placeholder": "2",
                },
                {
                    "key": "max_pages_per_year",
                    "label": "Pages per year",
                    "description": "Optional. Defaults to 8 order-history pages per year.",
                    "input_kind": "number",
                    "default_value": 8,
                    "placeholder": "8",
                },
                {
                    ...
                    "description": "Enabled by default. Turn this off if you want to watch the Amazon browser session during sync troubleshooting.",
                    "input_kind": "boolean",
                    "default_value": True,
                },
                {
    ...
    },
    {
        ...
        "license": "MIT",
        "runtime_kind": "builtin",
        "entrypoint": "lidltool.connectors.kaufland_adapter:KauflandConnectorAdapter",
        "auth_kind": "browser_session",
        "auth": {
            "auth_kind": "browser_session",
            "supports_live_session_bootstrap": True,
